...
This project demonstrates a robust home automation setup using Docker containers to orchestrate a collection of microservices. Each service is carefully isolated in its own containerized environment to ensure optimal performance and security. Key components include Home Assistant for central automation, Esphome for ESP32 device management, and Node-RED for creating event-driven workflows. Additional services such as Nextcloud, InfluxDB, and Zigbee2MQTT integrate seamlessly with Home Assistant to manage data, calendars, and device communication. Security is prioritized through the use of Traefik reverse proxies for secure HTTPS access, with LDAP authentication and Authelia providing streamlined and secure login capabilities across services. This modular, containerized approach allows for easy expansion and modification of the system as new devices and services are added.